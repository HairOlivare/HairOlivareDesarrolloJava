...
hinicio = document.getElementById("horain");
hfin = document.getElementById("horafin");
 ...
 function validar(){
 	...
 	if (nombre.value == "" || apellido.value == "") {
 		Swal.fire({
		  ...
		  icon: 'warning',
		  title:'Incompleto',
		  text: 'Debe ingresar nombres y apellidos del encargado',
	...
	if (canti.value == "") {
		Swal.fire({
		  ...
		  icon: 'warning',
		  title: 'Incompleto',
		  text: 'Debe ingresar una cantidad del producto',
		  showConfirmButton: false,
	  	  timer: 2000,
		});
		canti.focus();
	...
	Swal.fire({
	  ...
	  icon: 'success',
	  title: 'Confirmada',
	  text: 'Ha sido registrada con exito la producción',
	  showConfirmButton: false,
	  timer: 2500
	});
