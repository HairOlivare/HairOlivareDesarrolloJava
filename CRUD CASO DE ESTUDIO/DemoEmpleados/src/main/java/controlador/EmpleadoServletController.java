 ...
 */
@WebServlet("/EmpleadoServletController")
		...
		if (request.getParameter("action")!= null) {
			...
			switch (action) {
			  case "edit": 
				  ...
				  request.getRequestDispatcher("empleados/updateEmpleado.jsp").forward(request,response); 
				  break;
			  case "eliminar": 
				  System.out.println("@Eliminar"); 
				  int Id=Integer.parseInt(request.getParameter("id_Empleado"));
				  empleadoImp.eliminarEmpleado(Id);
				  this.listaEmpleado=empleadoImp.findAll(); 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("action")!= null) {
			...
			case "Crear":
				...
				empleadoImp.createEmpleado(empleadoCrea);
				this.listaEmpleado = empleadoImp.findAll();
				request.setAttribute("empleados", this.listaEmpleado);
				request.getRequestDispatcher("empleados/listEmpleados.jsp").forward(request, response);
				break;
